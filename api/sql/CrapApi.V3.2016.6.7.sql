...
INSERT INTO `setting` (`id`, `mkey`, `value`, `remark`, `createTime`, `status`, `type`, `canDelete`) VALUES ('fpmbdc8b-9cd8-4839-b38a-1cea3ceb3945', 'FONT_FAMILY', '\"Lantinghei SC\", \"Open Sans\", Arial, \"Hiragino Sans GB\", \"Microsoft YaHei\", \"STHeiti\", \"WenQuanYi Micro Hei\", SimSun, sans-serif;
', '网站字体', '2016-06-09 13:07:37', '1', 'FONTFAMILY', '0');

ALTER TABLE `setting` 
CHANGE COLUMN `value` `value` VARCHAR(500) NOT NULL ;

INSERT INTO `setting` (`id`, `mkey`, `value`, `remark`, `createTime`, `status`, `type`, `canDelete`) 
